...
Interface.getUserId = function() {
    return _isMzBrower ? Interface.getUserInfoBy('uid')() : EventJavascriptInterface.getUserId() 
}
...
Interface.oauthRequest = function(url, dataStr) {
    ...
    if(!_isMzBrower) {
        var dataObj = dataStr
        dataObj.uid = Interface.getUserId()
        // dataObj.access_token = Interface.getUserToken()
        ...
        //console.log(2222,Vue.http);
        return Vue.http.jsonp(`https://api-game.meizu.com/games${url}`, {
            jsonp: 'jsonpCallback',
        ...
        global.__PROMISE_MAP__[tag] = new Vue.Promise()
...
Interface.lottery = function(zippoArr) {
    if(_isMzBrower) {
        ...
        return Vue.http.jsonp(`'https://api-game.meizu.com/games/oauth/activity/zippo/do/${global.__ACTIVITY_ID__}`, {
        ...
        global.__PROMISE_MAP__[_lotteryTag] = new Vue.Promise()
